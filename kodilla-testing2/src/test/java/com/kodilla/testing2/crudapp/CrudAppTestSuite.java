...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://sebastiansobieraj.github.io/";
    ...
    private boolean checkTestExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("sebastian.sobieraj91@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("sebastian91");
    ...
    @Test
    public void souldCreateTrelloCard() throws InterruptedException {
